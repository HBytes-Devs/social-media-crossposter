...
export function SmcMarkIcon() {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M1.371 5.476 11.943 0 22.63 5.476l-10.686 5.495L1.371 5.476Z"
      />
      <path
        fill="currentColor"
        d="m4.73 10.286 7.213 3.546 7.288-3.546 3.398 1.655-10.686 5.202L1.371 11.94l3.36-1.655Z"
      />
      <path
        fill="currentColor"
        d="m4.73 16.457 7.213 3.911 7.288-3.91 3.398 1.815L11.943 24 1.371 18.273l3.36-1.816Z"
      />
    </svg>
  );
}
...
export function ConnectorArrow() {
  return (
    <svg
      className="!h-[7px] !w-[6px] ![block-size:7px] ![inline-size:6px] shrink-0 text-[#213130]"
      width="6"
      height="7"
      viewBox="0 0 6 7"
      fill="currentColor"
...
export const CHANNEL_ICONS: Record<ChannelId, () => ReactNode> = {
  ...
  "youtube": YoutubeIcon,
  "x": XIcon,
  "google-business-profile": GoogleBusinessProfileIcon,
