...
import vertexShader from '../../../../Shaders/Seabed/vertex.glsl?raw';
import fragmentShader from '../../../../Shaders/Seabed/fragment.glsl?raw';
...
export default class Seabed {
  constructor() {
    ...
    const particleCount =
      typeof this.game.options?.seabedParticles === 'number'
        ? this.game.options.seabedParticles
        : 280_000;

    this.config = {
      // Login / dashboard: lighter than the full 2M demo for GPU comfort
      particleCount,
      gridSize: 300,
      gridDepth: 300,
      depth: -12,
